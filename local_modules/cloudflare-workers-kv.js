...
async function delMultiWithRestApi(keyValuePairs) {
...
async function delMulti(keyValuePairs) {

    return delMultiKV(keyValuePairs);
}
...
var delMultiKV = delMultiWithRestApi;
